...
const Footer = () => {
  return (
    <div>
      <footer className="footer text-base-content p-10  bg-[#1f98bf] justify-items-center">
        <nav>
          <p className=" text-white text-2xl">Services</p>
          <p className="link link-hover text-white">Branding</p>
          <p className="link link-hover text-white">Design</p>
          <p className="link link-hover text-white">Marketing</p>
        ...
        <nav>
          <p className=" text-white text-2xl">Social</p>
